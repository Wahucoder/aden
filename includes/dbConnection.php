...
class dbConnection{
    ...
    public function selectAllUsersAscending(){
        $sql = "SELECT * FROM users ORDER BY signup_date ASC"; // Adjust table and column names accordingly
        return $this->select_while($sql);
    }
